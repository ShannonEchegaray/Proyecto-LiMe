    ...
    <div className="fondoMain">
      <div
        className={`formContainer ${
          compra ? "flex flex-col justify-around items-center" : null
        }`}
      >
        {compra ? (
          <>
            <p className="text-lg font-bold">
              Has realizado la compra con exito, su id de compra es: {compra}
            </p>
          ...
          >
            ...
            <input
              ...
              required
              onChange={(e) =>
                setFormHandler({ ...formHandler, firstname: e.target.value })
              }
            ...
            <input
              ...
              required
              onChange={(e) =>
                setFormHandler({ ...formHandler, lastname: e.target.value })
              }
            ...
            <input
              ...
              className="text-white bg-blue-500 w-4/12"
              type="submit"
            />
          </form>
        )}
