    ...
    <div>
      ...
      {fPrice !== 0 ? (
        <div className="py-5 border-y border-grey border-solid flex flex-col items-end">
          ...
          <button
            className="text-sm text-white rounded bg-blue-500 p-2 mb-2"
            onClick={() => limpiar()}
          >
            Limpiar Carrito
          </button>
          <Link
            to="/form"
            className="text-sm text-white rounded bg-blue-500 p-2"
          >
            Continuar compra
          </Link>
        </div>
        ...
        <p className="text-center">
          Aqui no hay compras, puede hacer sus compras{" "}
