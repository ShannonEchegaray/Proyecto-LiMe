...
const SignIn = () => {
    ...
    const loguearse = (e) => {
        ...
        result ? authState({...authState, error: result}) : setAuthState({...authState, success: true})
    ...
    <div className='fondoMain'>
        <div className="formContainer">
            <form className="flex flex-col items-center form" onSubmit={loguearse}>
                ...
                <input type="text" required onChange={(e) => setFormHandler({...formHandler, email: e.target.value})} value={formHandler.email}/>
